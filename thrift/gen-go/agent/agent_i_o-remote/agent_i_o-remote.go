...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  Response SendRequest(Request req)")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	client := agent.NewAgentIOClientFactory(trans, protocolFactory)
	...
	case "SendRequest":
		...
		value0 := argvalue0
		fmt.Print(client.SendRequest(value0))
		fmt.Print("\n")
		break
	case "":
		Usage()
